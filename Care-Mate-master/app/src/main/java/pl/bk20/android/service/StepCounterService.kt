...
import pl.bk20.android.AndroidApp
import pl.bk20.android.R
import pl.bk20.android.core.data.repository.DayRepositoryImpl
import pl.bk20.android.core.domain.usecase.DayUseCases
import pl.bk20.android.core.presentation.MainActivity
...
class StepCounterService : LifecycleService(), SensorEventListener {
    ...
    override fun onCreate() {
        ...
        val application = application as AndroidApplication
